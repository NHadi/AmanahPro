...
import (
	"AmanahPro/services/breakdown-services/common/bootstrap"
	...
	commonMiddleware "AmanahPro/services/breakdown-services/common/middleware"
	"AmanahPro/services/breakdown-services/common/routes"
	...
	_ "AmanahPro/services/breakdown-services/docs"
...
func main() {
	...
	configureLogging()
	log.Println("Starting Breakdown Management Services API...")
