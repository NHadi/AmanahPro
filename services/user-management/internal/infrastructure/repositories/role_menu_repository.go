...
func (r *roleMenuRepository) HasPermission(roleID, menuID uuid.UUID, permission string) (bool, error) {
	var count int64
...
func (r *roleMenuRepository) FindMenusByRoleID(roleID uuid.UUID) ([]models.Menu, error) {
...
func (r *roleMenuRepository) RemoveMenu(roleID, menuID uuid.UUID) error {
...
func (r *roleMenuRepository) AssignPermission(roleID, menuID uuid.UUID, permission string) error {
