...
func NewSPKSectionRepository(db *gorm.DB) repositories.SPKSectionRepository {
	return &baSectionRepositoryImpl{
		db: db,
	}
}

// Create inserts a new SPKSection record into the database
func (r *baSectionRepositoryImpl) Create(section *models.SPKSection) error {
...
func (r *baSectionRepositoryImpl) Update(section *models.SPKSection) error {
...
func (r *baSectionRepositoryImpl) GetByID(sectionID int) (*models.SPKSection, error) {
