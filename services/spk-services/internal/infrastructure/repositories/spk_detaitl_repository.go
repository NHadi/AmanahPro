...
type spkDetailRepositoryImpl struct {
	db *gorm.DB
}
...
func NewSPKDetailRepository(db *gorm.DB) repositories.SPKDetailRepository {
	return &spkDetailRepositoryImpl{
		db: db,
	}
}

// Create inserts a new SPKDetail record into the database
func (r *spkDetailRepositoryImpl) Create(detail *models.SPKDetail) error {
...
func (r *spkDetailRepositoryImpl) Update(detail *models.SPKDetail) error {
...
func (r *spkDetailRepositoryImpl) Delete(detailId int) error {
...
func (r *spkDetailRepositoryImpl) GetByID(detailId int) (*models.SPKDetail, error) {
